...
//
// Auth: Vercel inyecta el header `Authorization: Bearer ${CRON_SECRET}`
// automáticamente si configurás la env var. Lo validamos para que nadie
// más pueda dispararlo.
export async function GET(request: Request) {
  ...
  // cleanup_orphan_profiles es una función SQL custom (migración 0018) y no
  // está reflejada en types/database.ts. Cast el cliente a untyped para usarla.
