  ...
  return (
    <>
      <button
        ...
        onClick={onClick}
        disabled={loading}
        className="flex items-center justify-center gap-2.5 py-3.5 px-4 rounded-full bg-paper-2 text-ink font-semibold text-sm tracking-tight shadow-[inset_0_0_0_1px_var(--color-border)] hover:bg-cream transition disabled:opacity-50"
      >
        <GoogleIcon />
